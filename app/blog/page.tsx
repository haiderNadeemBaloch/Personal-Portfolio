        ...
        {posts.length === 0 ? (
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            {posts.map((post) => (
              <article
                key={post.slug}
                className="group h-full overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl dark:border-gray-800 dark:bg-gray-900"
              >
                <Link
                  href={`/blog/${post.slug}`}
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-8">
                    ...
                    <div className="mt-6 flex flex-wrap items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <span className="text-primary-600 transition group-hover:text-primary-500 dark:text-primary-400">
                        Read article →
                      </span>
                    </div>
                  </div>
